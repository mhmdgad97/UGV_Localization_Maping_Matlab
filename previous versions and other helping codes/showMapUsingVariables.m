clear all
%this code has the same logic as the normal code and makes the same map but takes its data from a
%variable file not serial reading (look at memory variables file)
